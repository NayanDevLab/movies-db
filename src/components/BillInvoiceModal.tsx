      ...
      <div className="relative w-full max-w-4xl bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden flex flex-col my-auto max-h-[92vh]">
        ...
        <form onSubmit={handleConfirmPayment} className="p-6 overflow-y-auto space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 flex items-center gap-2">
                  <User className="w-4 h-4 text-violet-400" /> 1. Customer Information
                </h3>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-3 py-2 rounded-xl bg-slate-900 border border-slate-800 text-white placeholder-slate-500 focus:outline-none focus:border-violet-500"
                      />
                    </div>
                  </div>
              ...
              <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 flex items-center gap-2">
                  <CreditCard className="w-4 h-4 text-violet-400" /> 2. Payment Method
                </h3>
                ...
                {paymentMethod === 'upi' && (
                  <div className="p-3 rounded-xl bg-slate-900 border border-slate-800 text-center space-y-2">
                    <div className="w-24 h-24 mx-auto bg-white rounded-lg p-2 flex items-center justify-center shadow-md">
            ...
            <div className="lg:col-span-5 p-5 rounded-2xl bg-slate-950 border border-slate-800 space-y-4 flex flex-col justify-between">
              <div>
                <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1.5 pb-3 border-b border-slate-800">
                  <Receipt className="w-3.5 h-3.5 text-amber-400" /> Itemized Bill Breakdown
                </h3>
                ...
                <div className="space-y-2 pt-3 border-t border-slate-800 text-xs text-slate-400">
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-slate-800 text-base font-black text-white">
